...
namespace GW2DotNET.ChatLinks
{
    ...
    [ConverterFor(typeof(PointOfInterestChatLink))]
    internal class PointOfInterestChatLinkConverter : ChatLinkConverter
    {
        ...
        protected override ChatLink ConvertFromBytes(byte[] bytes)
        {
            ...
            var value = new PointOfInterestChatLink();
            ...
            // Set the Point of Interest identifier
            value.PointOfInterestId = BitConverter.ToInt32(buffer, 0);
        ...
        {
            return BitConverter.GetBytes(((PointOfInterestChatLink)value).PointOfInterestId);
        }
    }
}