...
namespace GW2NET.V2.Items.Converters
{
    ...
    internal sealed class ConverterForInfixUpgrade : IConverter<InfixUpgradeDataContract, InfixUpgrade>
    {
        ...
        /// <summary>Infrastructure. Holds a reference to a type converter.</summary>
        private readonly IConverter<BuffDataContract, ItemBuff> converterForCombatBuff;
        ...
        /// <param name="converterForCombatBuff">The converter for <see cref="ItemBuff"/>.</param>
        public ConverterForInfixUpgrade(IConverter<ICollection<AttributeDataContract>, ICollection<CombatAttribute>> converterForCombatAttributeCollection, IConverter<BuffDataContract, ItemBuff> converterForCombatBuff)
        {
