...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace GW2DotNET.V1.Skins.Details.Types
{
    using System;
    using System.Collections.Generic;

    using GW2DotNET.V1.Common.Converters;
    using GW2DotNET.V1.Skins.Details.Types.SkinTypes;
    using GW2DotNET.V1.Skins.Details.Types.SkinTypes.Armors;
    using GW2DotNET.V1.Skins.Details.Types.SkinTypes.Backs;
    using GW2DotNET.V1.Skins.Details.Types.SkinTypes.Weapons;
