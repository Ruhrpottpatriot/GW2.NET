...
namespace GW2DotNET.V1.Skins.Details.Converters
{
    ...
    using GW2DotNET.V1.Skins.Details.Contracts.SkinTypes.Armors.ArmorTypes;

    using Newtonsoft.Json;
    using Newtonsoft.Json.Linq;

    /// <summary>Converts an object to and/or from JSON.</summary>
    public class ArmorSkinConverter : JsonConverter
    {
        ...
        /// <summary>Initializes static members of the <see cref="ArmorSkinConverter" /> class.</summary>
        static ArmorSkinConverter()
        {
            var baseType = typeof(ArmorSkin);
        ...
        {
            return typeof(ArmorSkin) == objectType;
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            itemType = KnownTypes.TryGetValue(type, out itemType) ? itemType : typeof(UnknownArmorSkin);
