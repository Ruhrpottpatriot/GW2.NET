...
namespace GW2DotNET.V1.Skins.Details.Converters
{
    ...
    using GW2DotNET.V1.Skins.Details.Contracts.SkinTypes.Weapons.WeaponTypes;

    using Newtonsoft.Json;
    using Newtonsoft.Json.Linq;

    /// <summary>Converts an object to and/or from JSON.</summary>
    public class WeaponSkinConverter : JsonConverter
    {
        ...
        /// <summary>Initializes static members of the <see cref="WeaponSkinConverter" /> class.</summary>
        static WeaponSkinConverter()
        {
            var baseType = typeof(WeaponSkin);
        ...
        {
            return typeof(WeaponSkin) == objectType;
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            itemType = KnownTypes.TryGetValue(type, out itemType) ? itemType : typeof(UnknownWeaponSkin);
