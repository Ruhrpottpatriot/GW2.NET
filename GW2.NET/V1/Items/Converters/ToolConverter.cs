...
namespace GW2DotNET.V1.Items.Converters
{
    ...
    using GW2DotNET.V1.Items.Contracts.Tools;

    using Newtonsoft.Json;
    using Newtonsoft.Json.Linq;

    /// <summary>Converts an object to and/or from JSON.</summary>
    public class ToolConverter : TypeDiscriminatorConverter<Tool>
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            Type type = this.KnownTypes.TryGetValue(discriminator, out type) ? type : typeof(UnknownTool);
