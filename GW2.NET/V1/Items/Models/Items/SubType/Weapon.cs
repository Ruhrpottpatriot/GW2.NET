...
namespace GW2DotNET.V1.Items.Models.Items.SubType
{
    ...
    public class Weapon
    {
        /// <summary>Enumerates all possible weapon damage types.</summary>
        public enum WeaponDamageType
        {
            /// <summary>The weapon does physical damage.</summary>
            Physical, 

            /// <summary>The weapon does fire damage.</summary>
            Fire, 

            /// <summary>The weapon does ice damage.</summary>
            Ice, 

            /// <summary>The weapon does lightning damage.</summary>
            Lightning, 
        }

        /// <summary>Enumerates all possible weapon types.</summary>
        public enum WeaponType
        {
            ...
            /// <summary>A two handed toy.</summary>
            TwoHandedToy, 

            /// <summary>A large bundle (duh!)</summary>
            LargeBundle
        }
        ...
        /// <param name="minPower">The min power.</param>
        ...
        /// <summary>Gets the minimum power.</summary>
