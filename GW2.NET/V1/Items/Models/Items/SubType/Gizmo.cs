...
{
    /// <summary>The gizmo.</summary>
    [Serializable]
    public class Gizmo
    {
        /// <summary>Enumerates the gizmo types.</summary>
        public enum GizmoType
        {
            /// <summary>The default gizmo.</summary>
            Default, 

            /// <summary>A rentable contract npc.</summary>
            RentableContractNpc, 

            /// <summary>An unlimited consumable.</summary>
            UnlimitedConsumable, 
        }
