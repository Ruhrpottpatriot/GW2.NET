...
{
    /// <summary>The upgrade component.</summary>
    [Serializable]
    public class UpgradeComponent
    {
        /// <summary>Enumerates all upgrade component flags.</summary>
        public enum UpgradeComponentFlags
        {
            /// <summary>A heavy armor.</summary>
            HeavyArmor, 

            /// <summary>A medium armor.</summary>
            MediumArmor, 

            /// <summary>A light armor.</summary>
            LightArmor, 

            /// <summary>An axe.</summary>
            Axe, 

            /// <summary>A dagger.</summary>
            Dagger, 

            /// <summary>A focus.</summary>
            Focus, 

            /// <summary>A greatsword.</summary>
            Greatsword, 

            /// <summary>A hammer.</summary>
            Hammer, 

            /// <summary>A harpoon.</summary>
            Harpoon, 

            /// <summary>A long bow.</summary>
            LongBow, 

            /// <summary>A mace.</summary>
            Mace, 

            /// <summary>A pistol.</summary>
            Pistol, 

            /// <summary>A rifle.</summary>
            Rifle, 

            /// <summary>A scepter.</summary>
            Scepter, 

            /// <summary>A shield.</summary>
            Shield, 

            /// <summary>A short bow.</summary>
            ShortBow, 

            /// <summary>A speargun.</summary>
            Speargun, 
            ...
            /// <summary>A torch.</summary>
            Torch, 

            /// <summary>A trident.</summary>
            Trident, 

            /// <summary>A trinket.</summary>
            Trinket, 

            /// <summary>A warhorn.</summary>
            Warhorn
        }

        /// <summary>Enumerates all possible upgrade types.</summary>
        public enum UpgradeType
        {
            /// <summary>A rune.</summary>
            Rune, 

            /// <summary>A default upgrade.</summary>
            Default, 

            /// <summary>A sigil.</summary>
            Sigil, 
        ...
        /// <param name="infusionUpgradeType">The infusion upgrade type.</param>
        ...
        /// <summary>Gets the upgrade type.</summary>
        [JsonProperty("type")]
        ...
        /// <summary>Gets the infusion upgrade type.</summary>
        [JsonProperty("infusion_upgrade_flags")]
        public IEnumerable<UpgradeFlag> InfusionUpgradeType { get; private set; }
        ...
        [JsonProperty("flags")]
        public IEnumerable<UpgradeComponentFlags> Flags { get; private set; }
    }
}