...
{
    /// <summary>The trinket.</summary>
    [Serializable]
    public class Trinket
    {
        /// <summary>Enumerates the trinket types.</summary>
        public enum TrinketType
        {
            /// <summary>The trinket is a ring.</summary>
            Ring, 

            /// <summary>The trinket is an accessory.</summary>
            Accessory, 

            /// <summary>The trinket is an amulet.</summary>
            Amulet, 
        }
