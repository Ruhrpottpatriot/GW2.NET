...
namespace GW2DotNET.V1.Items.Models.Items
{
    ...
    public class Item : IEquatable<Item>
    {
        ...
        /// <param name="vendorValue">The vendor value.</param>
        ...
        /// <param name="weaponDetails">The weapon details.</param>
        /// <param name="upgradeComponentDetails">The upgrade component details.</param>
        /// <param name="trophyDetails">The trophy details.</param>
        /// <param name="trinketDetails">The trinket details.</param>
        /// <param name="toolDetails">The tool details.</param>
        /// <param name="gizmoDetails">The gizmo details.</param>
        /// <param name="gatheringDetails">The gathering details.</param>
        /// <param name="craftingMaterialDetails">The crafting material details.</param>
        /// <param name="containerDetails">The container details.</param>
        /// <param name="consumableDetails">The consumable details.</param>
        /// <param name="bagDetails">The bag details.</param>
        /// <param name="backDetails">The back details.</param>
        /// <param name="armourDetails">The armour details.</param>
        [JsonConstructor]
        ...
        /// <summary>Gets the minimum level to use.</summary>
        [JsonProperty("level")]
        ...
        /// <summary>Determines if two instances of the specified <see cref="Item" /> are equal.</summary>
        ...
        /// <summary>Determines if two instances of the specified <see cref="Item" /> are not equal.</summary>
        /// <param name="itemA">The first item.</param>
        /// <param name="itemB">The second item.</param>
