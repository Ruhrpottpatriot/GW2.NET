...
namespace GW2DotNET.V1.DynamicEvents.Converters
{
    ...
    public class LocationConverter : TypeDiscriminatorConverter<Location>
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            Type type = this.KnownTypes.TryGetValue(discriminator, out type) ? type : typeof(UnknownLocation);
