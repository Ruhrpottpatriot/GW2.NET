// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GameEventState.cs" company="GW2.Net Coding Team">
...
{
    /// <summary>Enumerates all possible states an event can be.</summary>
    public enum GameEventState
    {
        ...
        /// <summary>The event is inactive, and will only become active once certain criteria are met.</summary>
        Warmup, 
        ...
        /// <summary>The event is invalid. For now no further information were released by Arena Net</summary>
        Invalid, 

        /// <summary>The event is not running now.</summary>
        Inactive
    }
}