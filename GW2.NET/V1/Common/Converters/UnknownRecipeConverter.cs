...
namespace GW2DotNET.V1.Common.Converters
{
    ...
    public sealed class UnknownRecipeConverter : JsonConverter
    {
        ...
        {
            var recipeId = serializer.Deserialize<int?>(reader);
            if (!recipeId.HasValue)
            {
                return null;
            }

            return new UnknownRecipe { RecipeId = recipeId.Value };
        }
        ...
        {
            serializer.Serialize(writer, ((Recipe)value).RecipeId);
        }
    }
}