// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnknownWorldConverter.cs" company="GW2.NET Coding Team">
...
namespace GW2DotNET.V1.Common.Converters
{
    ...
    public sealed class UnknownWorldConverter : JsonConverter
    {
        ...
        {
            return objectType == typeof(World);
        }
        ...
        {
            var worldId = serializer.Deserialize<int?>(reader);
            if (!worldId.HasValue)
            {
                return null;
            }

            return new World { Id = worldId.Value };
        }
        ...
        {
            serializer.Serialize(writer, ((World)value).Id);
        }
    }
}