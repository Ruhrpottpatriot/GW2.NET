// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnknownContinentConverter.cs" company="GW2.NET Coding Team">
...
namespace GW2DotNET.V1.Common.Converters
{
    ...
    public sealed class UnknownContinentConverter : JsonConverter
    {
        ...
        {
            return objectType == typeof(Continent);
        }
        ...
        {
            var continentId = serializer.Deserialize<int?>(reader);
            if (!continentId.HasValue)
            {
                return null;
            }

            return new Continent { ContinentId = continentId.Value };
        }
        ...
        {
            serializer.Serialize(writer, ((Continent)value).ContinentId);
        }
    }
}