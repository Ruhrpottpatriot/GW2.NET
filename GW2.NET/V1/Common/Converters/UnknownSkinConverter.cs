...
namespace GW2DotNET.V1.Common.Converters
{
    ...
    public sealed class UnknownSkinConverter : JsonConverter
    {
        ...
        {
            var skinId = serializer.Deserialize<int?>(reader);
            if (!skinId.HasValue)
            {
                return null;
            }

            return new UnknownSkin { SkinId = skinId.Value };
        }
        ...
        {
            serializer.Serialize(writer, ((Skin)value).SkinId);
        }
    }
}