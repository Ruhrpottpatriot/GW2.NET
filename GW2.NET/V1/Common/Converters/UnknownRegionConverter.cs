// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnknownRegionConverter.cs" company="GW2.NET Coding Team">
...
namespace GW2DotNET.V1.Common.Converters
{
    ...
    public sealed class UnknownRegionConverter : JsonConverter
    {
        ...
        {
            var regionId = serializer.Deserialize<int?>(reader);
            if (!regionId.HasValue)
            {
                return null;
            }

            return new Region { RegionId = regionId.Value };
        }
        ...
        {
            serializer.Serialize(writer, ((Region)value).RegionId);
        }
    }
}