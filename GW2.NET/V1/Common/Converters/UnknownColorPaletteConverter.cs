// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnknownColorPaletteConverter.cs" company="GW2.NET Coding Team">
...
namespace GW2DotNET.V1.Common.Converters
{
    ...
    public sealed class UnknownColorPaletteConverter : JsonConverter
    {
        ...
        {
            var colorId = serializer.Deserialize<int?>(reader);
            if (!colorId.HasValue)
            {
                return null;
            }

            return new ColorPalette { ColorId = colorId.Value };
        }
        ...
        {
            serializer.Serialize(writer, ((ColorPalette)value).ColorId);
        }
    }
}