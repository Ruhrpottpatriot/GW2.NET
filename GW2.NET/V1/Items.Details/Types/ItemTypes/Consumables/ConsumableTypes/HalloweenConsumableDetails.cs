...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace GW2DotNET.V1.Items.Details.Types.ItemTypes.Consumables.ConsumableTypes
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="HalloweenConsumableDetails" /> class.</summary>
