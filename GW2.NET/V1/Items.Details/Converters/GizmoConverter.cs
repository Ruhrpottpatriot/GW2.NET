...
namespace GW2DotNET.V1.Items.Details.Converters
{
    ...
    using GW2DotNET.V1.Items.Details.Contracts.Gizmos;

    using Newtonsoft.Json;
    using Newtonsoft.Json.Linq;

    /// <summary>Converts an object to and/or from JSON.</summary>
    public class GizmoConverter : TypeDiscriminatorConverter<Gizmo>
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            Type type;
            type = this.KnownTypes.TryGetValue(discriminator, out type) ? type : typeof(UnknownGizmo);
