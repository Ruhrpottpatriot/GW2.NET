...
{
    /// <summary>Exposes properties and methods which allow the user to query and manipulate data coming from the Guild Wars 2 api.</summary>
    public interface IDataManager
    {
        ...
        /// <summary>Gets the game build.</summary>
        int Build { get; }
        ...
        DataProvider DynamicEventsData { get; }
        ...
        ContinentData ContinentData { get; }

        /// <summary>Gets the map floor data.</summary>
        MapFloorData MapFloorData { get; }

        /// <summary>Gets the maps data.</summary>
        MapsData MapsData { get; }
        ...
        /// <remarks><para>This method changes the location of the written cache and moves the existing cache to it's new location. This method will not overwrite existing files. If you want to overwrite existing files you have to use the <see cref="ChangeSavePath(string,bool)"/> method.</para>
