...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace GW2DotNET.V1.ItemsDetails.Types.ItemTypes.Weapons
{
    using System;
    using System.Collections.Generic;

    using GW2DotNET.V1.Common.Converters;
    using GW2DotNET.V1.ItemsDetails.Types.ItemTypes.Weapons.WeaponTypes;
    ...
    public class WeaponDetailsConverter : ContentBasedTypeCreationConverter
    {
        ...
        protected override Type GetTargetType(Type objectType, JObject content)
        {
            ...
            try
            {
                ...
                {
                    type = JsonSerializer.Create().Deserialize<WeaponType>(jsonToken.CreateReader());
                }
