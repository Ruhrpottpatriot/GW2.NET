...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace GW2DotNET.V1.WorldVersusWorld.Matches.Details.Types.Maps
{
    using System.Runtime.Serialization;

    using GW2DotNET.V1.Common.Types;
    using GW2DotNET.V1.WorldVersusWorld.Matches.Details.Types.Common;
    using GW2DotNET.V1.WorldVersusWorld.Matches.Details.Types.Maps.Bonuses;
    using GW2DotNET.V1.WorldVersusWorld.Matches.Details.Types.Maps.Objectives;
