...
namespace GW2DotNET.V1.Events.DataProviders
{
    ...
    public class EventData : IEnumerable<GwEvent>
    {
        ...
        internal EventData(ApiManager apiManager)
        {
            ...
            this.eventNamesCache = new Lazy<Dictionary<Guid, string>>(this.InitializeEventNamesCache);

            this.eventsCache = new Lazy<IEnumerable<GwEvent>>(() => this.GetEvents());
        }
        ...
        public IEnumerable<GwEvent> this[GwWorld world]
        {
            get
            {
                return this.BypassCaching ? this.GetEvents(world.Id) : this.eventsCache.Value.Where(w => w.WorldId == world.Id);
            }
        }
        ...
        public IEnumerable<GwEvent> this[Map map]
        {
            get
            {
                return this.BypassCaching ? this.GetEvents(mapId: map.Id) : this.eventsCache.Value.Where(e => e.MapId == map.Id);
            }
        }
