...
namespace GW2DotNET.V1
{
    ...
    using GW2DotNET.V1.WorldVersusWorld.MatchesDetails;
    using GW2DotNET.V1.WorldVersusWorld.MatchesDetails.Types;
    using GW2DotNET.V1.WorldVersusWorld.ObjectiveNames;
    using GW2DotNET.V1.WorldVersusWorld.ObjectiveNames.Types;
