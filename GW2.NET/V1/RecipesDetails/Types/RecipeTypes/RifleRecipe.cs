...
namespace GW2DotNET.V1.RecipesDetails.Types.RecipeTypes
{
    ...
    /// <summary>Represents detailed information about a rifle crafting recipe.</summary>
    [JsonConverter(typeof(DefaultJsonConverter))]
    public class RifleRecipe : Recipe
    {
        /// <summary>Initializes a new instance of the <see cref="RifleRecipe" /> class.</summary>
        public RifleRecipe()
