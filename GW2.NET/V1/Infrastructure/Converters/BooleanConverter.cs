...
{
    /// <summary>The boolean converter.</summary>
    internal class BooleanConverter : JsonConverter
    {
        ...
        /// <summary>Checks if the type can be converted to a boolean value</summary>
        /// <param name="objectType">The object type.</param>
        /// <returns>True if the type can be converted to a boolean value, otherwise false.</returns>
