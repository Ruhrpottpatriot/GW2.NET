...
// </copyright>
// <summary>
//   Converts a  to and from its numeric  representation.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace GW2DotNET.V1.Core.Common.Converters
{
    ...
    /// <summary>Converts a <see cref="System.Boolean" /> to and from its numeric <see cref="System.String" /> representation.</summary>
