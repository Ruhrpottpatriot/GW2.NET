...
namespace GW2DotNET.V1.Core
{
    ...
    public abstract class JsonDictionary<TKey, TValue> : JsonObject, IDictionary<TKey, TValue> where TValue : JsonObject
    {
        ...
        ///     found in the <see cref="JsonDictionary{TKey, TValue}" />.
        /// </returns>
        ...
        /// <returns>
        ///     true if item was successfully removed from the <see cref="System.Collections.Generic.ICollection{T}" />;
        ...
        /// </param>
        /// <returns>
        ///     true if the <see cref="JsonDictionary{TKey, TValue}" /> contains an element with the specified key; otherwise,
        ///     false.
        /// </returns>
