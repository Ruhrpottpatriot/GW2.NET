...
namespace GW2DotNET.V1.Core.Items.Details.ItemTypes.Trinkets
{
    ...
    using GW2DotNET.V1.Core.Items.Details.ItemTypes.Trinkets.TrinketTypes;

    using Newtonsoft.Json;
    using Newtonsoft.Json.Linq;

    /// <summary>
    ///     Converts an instance of a class that extends <see cref="TrinketDetails" /> from its <see cref="System.String" />
    ///     representation.
    /// </summary>
