...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace GW2DotNET.V1.Core.Items.Details.ItemTypes.UpgradeComponents.UpgradeComponentTypes
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="SigilUpgradeComponentDetails" /> class.</summary>
