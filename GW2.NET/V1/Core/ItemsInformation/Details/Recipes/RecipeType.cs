...
namespace GW2DotNET.V1.Core.ItemsInformation.Details.Recipes
{
    ...
    public enum RecipeType
    {
        ...
        [EnumMember(Value = "Greatsword")] GreatSword,

        /// <summary>The 'Mace' recipe type.</summary>
        [EnumMember(Value = "Mace")] Mace,
        ...
        [EnumMember(Value = "Refinement")] Refinement,

        /// <summary>The 'Upgrade Component' recipe type.</summary>
        [EnumMember(Value = "UpgradeComponent")] UpgradeComponent,
