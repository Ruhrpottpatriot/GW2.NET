...
namespace GW2DotNET.V1.Core.ItemsInformation.Details.Items.Consumables.Unlock
{
    ...
    public enum UnlockType
    {
        ...
        [EnumMember(Value = "BagSlot")] BagSlot = 1 << 0,

        /// <summary>The 'Bank Tab' unlock type.</summary>
        [EnumMember(Value = "BankTab")] BankTab = 1 << 1,

        /// <summary>The 'Crafting Recipe' unlock type.</summary>
        [EnumMember(Value = "CraftingRecipe")] CraftingRecipe = 1 << 2,

        /// <summary>The 'Dye' unlock type.</summary>
        [EnumMember(Value = "Dye")] Dye = 1 << 3
    }
}