...
namespace GW2DotNET.V1.Core.ItemsInformation.Details.Items.Consumables
{
    ...
    public enum ConsumableType
    {
        ...
        /// </summary>
        [EnumMember(Value = "AppearanceChange")] AppearanceChange = 1 << 0,

        /// <summary>
        ///     The 'Booze' consumable type.
        /// </summary>
        [EnumMember(Value = "Booze")] Booze = 1 << 1,

        /// <summary>
        ///     The 'Contract NPC' consumable type.
        /// </summary>
        [EnumMember(Value = "ContractNpc")] ContractNpc = 1 << 2,

        /// <summary>
        ///     The 'Food' consumable type.
        /// </summary>
        [EnumMember(Value = "Food")] Food = 1 << 3,

        /// <summary>
        ///     The 'Generic' consumable type.
        /// </summary>
        [EnumMember(Value = "Generic")] Generic = 1 << 4,

        /// <summary>
        ///     The 'Halloween' consumable type.
        /// </summary>
        [EnumMember(Value = "Halloween")] Halloween = 1 << 5,

        /// <summary>
        ///     The 'Immediate' consumable type.
        /// </summary>
        [EnumMember(Value = "Immediate")] Immediate = 1 << 6,

        /// <summary>
        ///     The 'Transmutation' consumable type.
        /// </summary>
        [EnumMember(Value = "Transmutation")] Transmutation = 1 << 7,

        /// <summary>
        ///     The 'Unlock' consumable type.
        /// </summary>
        [EnumMember(Value = "Unlock")] Unlock = 1 << 8,

        /// <summary>
        ///     The 'Utility' consumable type.
        /// </summary>
        [EnumMember(Value = "Utility")] Utility = 1 << 9
    }
}