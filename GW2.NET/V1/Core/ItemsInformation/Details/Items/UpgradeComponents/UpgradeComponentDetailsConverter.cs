...
using GW2DotNET.V1.Core.ItemsInformation.Details.Items.UpgradeComponents.Sigils;
using GW2DotNET.V1.Core.ItemsInformation.Details.Items.UpgradeComponents.Unknown;
