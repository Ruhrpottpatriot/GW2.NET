...
namespace GW2DotNET.V1.Items.Details.Contracts.ItemTypes.UpgradeComponents
{
    ...
    /// <summary>Converts an instance of a class that extends <see cref="UpgradeComponentDetails" /> from its <see cref="System.String" /> representation.</summary>
    public class UpgradeComponentDetailsConverter : ContentBasedTypeCreationConverter
    {
        ...
        protected override Type GetTargetType(Type objectType, JObject content)
        {
            ...
            try
            {
                ...
                {
                    type = JsonSerializer.Create().Deserialize<UpgradeComponentType>(jsonToken.CreateReader());
                }
