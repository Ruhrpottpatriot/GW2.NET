...
namespace GW2DotNET
{
    ...
    public static class ChatLinks
    {
        ...
        /// <remarks>
        ///     The value to this method has to be supplied in copper. One gold is 100 silver and one silver is 100 copper,
        ///     making one gold 10000 copper.
        /// </remarks>
        ...
        /// <remarks>
        ///     The item quantity is the amount of items which the user wants to link (e.g. 10 Copper Ore), while the item ID
        ///     is the ID gained from the API or another location.
        /// </remarks>
        ...
        /// <returns>A chat link representing certain phrases used in-game.</returns>
